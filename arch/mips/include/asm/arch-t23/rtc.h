...
#define RTC_HCR		0x20 //T23 delete
#define RTC_HWFCR	0x24 //T23 delete
#define RTC_HRCR	0x28 //T23 delete
#define RTC_HWCR	0x2C //T23 delete
#define RTC_HWRSR	0x30 //T23 delete
#define RTC_HSPR	0x34 //T23 delete
#define RTC_WENR	0x3C
#define RTC_CKPCR	0x40 //T23 delete
...
#define RTC_RTCCR_SELEXC	(1 << 1) //T23 delete
