...
#define CPM_CPEPCR   (0x58) //T23 delete
#define CPM_LPCDR	 (0x64)
#define CPM_MSC0CDR	 (0x68)

/*#define CPM_I2SCDR 	 (0x60) //T23 delete*/
#define CPM_I2SSPKCDR   (0x70) //T23 change
#define CPM_SSICDR	 (0x74)
#define CPM_I2SSPKCDR1  (0x78) //T23 change
#define CPM_CIMCDR	 (0x7c)
#define CPM_ISPCDR	 (0x80)
#define CPM_I2SMICCDR	 (0x84) //T23 add
#define CPM_I2SMICCDR1 (0x88) //T23 add
...
#define CPM_CPVPACR	 (0Xe4) //T23 add
...
#define CPM_SRBC1   (0xAC) //T23 delete
#define CPM_MESTSEL (0xEC)
#define CPM_ERNG    (0xD8) //T23 delete
#define CPM_RNG     (0xDC) //T23 delete
/*
#define MEMSCR0     (0xF0)
#define MEMSCR1     (0xF4)
#define MEMPDR0     (0xF8)
*/
#define MEMCTRL_MA0     (0xF0)
#define MEMCTRL_MA1     (0xF4)
#define MEMCTRL_MA2     (0xF8)
...
#define CPM_CLKGR_RSA		(1 << 27) //T23
#define CPM_CLKGR_RISCV		(1 << 26) //T23
#define CPM_CLKGR_MIPI		(1 << 25) //T23
#define CPM_CLKGR_LCD		(1 << 24) //T23
#define CPM_CLKGR_ISP		(1 << 23)
#define CPM_CLKGR_PDMA		(1 << 21)
#define CPM_CLKGR_SFC		(1 << 20)
#define CPM_CLKGR_SSI1		(1 << 19)
#define CPM_CLKGR_SC_HASH	(1 << 18)
#define CPM_CLKGR_SSI_SLV	(1 << 17)
...
#define CPM_CLKGR1_RADIX    (1 << 12) //T23 delete
#define CPM_CLKGR1_SYS_OST	(1 << 11)
#define CPM_CLKGR1_AHB0		(1 << 10)
#define CPM_CLKGR1_LDC      (1 << 9) //T23 delete
...
#define USBPCR_VBUSVLDEXT	(1 << 24) //T23 delete
#define USBPCR_VBUSVLDEXTSEL	(1 << 23) //T23 delete
#define USBPCR_POR		(1 << 22)
#define USBPCR_OTG_DISABLE	(1 << 20) //T23 delete
